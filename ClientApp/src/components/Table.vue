      ...
      <thead class="bg-gray-200 text-gray-600">
        <tr>
          <th
            ...
            :class="[
              'py-2 px-4',
              headers.length > 3 ? 'text-center' : 'text-left',
            ]"
          >
            {{ header }}
          </th>
        ...
        <tr v-for="user in users" :key="user.username">
          ...
          <td class="px-6 py-4">
            <button
              ...
              class="bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br text-white px-4 py-2 rounded-md"
            >
              Delete User
            </button>
          </td>
