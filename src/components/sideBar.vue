        ...
        >
          <ul class="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                <i
                  class="fa-solid fa-gear flex-shrink-0 w-5 h-5 mt-1 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                ></i>
