      ...
      <div class="grid lg:grid-cols-3 md:grid-cols-1 gap-4">
        ...
        <Card>
          ...
          <form @submit.prevent="addCategory()">
            ...
            />
            <button
              class="mt-4 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br text-white px-4 py-2 rounded-md w-full"
            >
              Add
            </button>
          </form>
        ...
        <Card>
          ...
          <button
            ...
            class="mt-4 bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br text-white px-4 py-2 rounded-md w-full"
          >
            Delete
          </button>
        </Card>
...
const totalPages = computed(() => {
  if (searchQuery.value.trim() !== "") {
    ...
    const totalUsers = users.value.filter(
...
function changePage(page: number) {
  ...
  router.push({
    query: {
      usersPerPage: String(usersPerPage.value),
      currPage: String(currPage.value),
    },
  });
  if (searchQuery.value.trim() !== "") {
    searchUser();
...
function deleteCategories() {
  axios
    .delete(`${url}api/deletecategories`, {
