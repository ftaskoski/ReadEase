<template>
 <div class="overflow-none mt-2">
  <table class="md:w-full sm:w-auto divide-y divide-gray-200">
      ...
      <tbody class="bg-white divide-y divide-gray-200">
        <tr class="hover:bg-gray-100" v-for="book in books" :key="book.bookId">
          ...
          <td class="text-sm text-gray-500 pb-2 flex justify-center flex-col sm:flex-row sm:items-center sm:justify-center">
  <button @click="openModal(book.bookId)" class="inline-flex items-center px-4 mt-2 mr-2 py-2 bg-red-600 transition ease-in-out delay-75 hover:bg-red-700 text-white text-sm font-medium rounded-md hover:-translate-y-1 hover:scale-2">
  ...
  <button @click="openEditModal(book)" class="inline-flex items-center px-4 mt-2 mr-2 py-2 bg-blue-600 transition ease-in-out delay-75 hover:bg-blue-700 text-white text-sm font-medium rounded-md hover:-translate-y-1 hover:scale-2">
    <svg fill="#ffffff" class="h-5 w-5 mr-2" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 348.882 348.882" xml:space="preserve" stroke-width="2" stroke-linejoin="round" stroke-linecap="round">
      <g>
  ...
  <button @click="download(book.bookId)" class="inline-flex items-center px-4 mt-2 mr-2 py-2 bg-yellow-600 transition ease-in-out delay-75 hover:bg-yellow-700 text-white md:text-sm sm:text-xs font-medium rounded-md hover:-translate-y-1 hover:scale-2">
